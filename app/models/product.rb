class Product < ApplicationRecord
  ...
  enum house_direction: %i(none north north_east east south_east south south_west west north_west)
  enum bacony_direction: %i(none north north_east east south_east south south_west west north_west)
end
