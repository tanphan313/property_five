module ProductPresentable
  ...
  delegate :id, :title, :price, :project, :acreage, :address, :editor_email, :editor_type, :price,
    :price_type_id, :product_type_id, :product_category_id, :product_images, :description, :facade,
    :entrance, :house_direction, :bacony_direction, :num_floor, :num_bedroom, :num_toilet, :furniture,
