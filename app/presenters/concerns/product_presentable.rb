module ProductPresentable
  ...
  delegate :id, :title, :price, :project, :acreage, :address, :editor_id, :editor_email, :editor_type, :price,
    ...
    :contact_name, :contact_address, :contact_phone, :contact_mobile_phone, :featured,
    :contact_email, :created_at, :updated_at, to: :product
  delegate :master_image, :product_images, :product_image_ids, :product_amenity_ids, to: :product
